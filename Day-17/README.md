...
| Method                                       | Returns                | Type                  |
| -------------------------------------------- | ---------------------- | --------------------- |
| `document.getElementById(id)`                | A single element       | `Element` (or `null`) |
| `document.getElementsByTagName(tagName)`     | Collection of elements | `HTMLCollection`      |
| `document.getElementsByClassName(className)` | Collection of elements | `HTMLCollection`      |
| `document.querySelector(css selector)`       | First matching element | `Element` (or `null`) |
| `document.querySelectorAll(css selector)`    | Collection of elements | `NodeList`            |
