...
function loadQuestion() {
  ...
  // if this function is called after showResult() is called the resultEl will be empty.
  resultEl.innerHTML = "";
...
function showResult() {
  ...
  // the currentQuestion will be 0 so that when the restart button will be clicked, the quize game will be started.
  currentQuestion = 0
  ...
  resultEl.innerHTML = `
      ...
      <button onclick="loadQuestion()">Restart Quiz</button>
  `
}
